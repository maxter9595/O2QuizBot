    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver_telegram', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='receiver_transactions1', to='tgbot.authorization', to_field='telegram_id')),
                ('sender_telegram', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sender_transactions1', to='tgbot.authorization', to_field='telegram_id')),
                ('transferor_telegram', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='transferor_transactions1', to='tgbot.authorization', to_field='telegram_id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_place', models.IntegerField(default=0, null=True)),
                ('tournament_points', models.IntegerField(default=0, null=True)),
                ('tournament_place', models.IntegerField(default=0, null=True)),
                ('quiz_points', models.IntegerField(default=0, null=True)),
                ('quiz_place', models.IntegerField(default=0, null=True)),
                ('participant_telegram', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='participant_telegram', to='tgbot.authorization', to_field='telegram_id')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('points_transferred', models.PositiveIntegerField(null=True)),
                ('is_done', models.BooleanField(choices=[(True, 'Да'), (False, 'Нет')], default=False)),
                ('receiver_telegram', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='receiver_transactions2', to='tgbot.authorization', to_field='telegram_id')),
                ('sender_telegram', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sender_transactions2', to='tgbot.authorization', to_field='telegram_id')),
                ('transferor_telegram', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='transferor_transactions2', to='tgbot.authorization', to_field='telegram_id')),
                ('tournament', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tournament', to='tgbot.tournament')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tournament', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tgbot.tournament')),
            ],
        ),
    ]
